...
export const MOCK_STAFF: Staff[] = [
  { id: 's0', name: 'Jason Ruiz', email: 'admin@hotel.com', role: 'Superuser', status: 'On Duty', shift: 'Always', pin: '0000' },
  { id: 's1', name: 'Sarah Connor', email: 'manager@hotel.com', role: 'Manager', status: 'On Duty', shift: 'Morning', pin: '1234' },
  { id: 's2', name: 'John Doe', email: 'reception@hotel.com', role: 'Reception', status: 'On Duty', shift: 'Morning', pin: '0000' },
